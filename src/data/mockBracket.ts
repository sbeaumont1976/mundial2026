...
const r32: Match[] = [
  m({ id: 'm32_1', round: 'r32', order: 1, kickoff: '2026-06-28T21:00:00+02:00', venue: 'SoFi Stadium · Los Ángeles', home: T('za'), away: T('ca'), home_score: 0, away_score: 1, status: 'finished' }),
  m({ id: 'm32_2', round: 'r32', order: 2, kickoff: '2026-06-29T19:00:00+02:00', venue: 'NRG Stadium · Houston', home: T('br'), away: T('jp'), home_score: 2, away_score: 1, status: 'finished' }),
  m({ id: 'm32_3', round: 'r32', order: 3, kickoff: '2026-06-29T22:30:00+02:00', venue: 'Gillette Stadium · Boston', home: T('de'), away: T('py'), home_score: 1, away_score: 1, pens: [3, 4], status: 'finished' }),
...
const r16: Match[] = [
  m({ id: 'm16_1', round: 'r16', order: 1, kickoff: '2026-07-04T19:00:00+02:00', venue: 'NRG Stadium · Houston', home: W('m32_1'), away: W('m32_4') }),
  m({ id: 'm16_2', round: 'r16', order: 2, kickoff: '2026-07-04T23:00:00+02:00', venue: 'Lincoln Financial Field · Filadelfia', home: W('m32_3'), away: W('m32_6') }),
  m({ id: 'm16_3', round: 'r16', order: 3, kickoff: '2026-07-05T22:00:00+02:00', venue: 'MetLife Stadium · Nueva York/N.J.', home: W('m32_2'), away: W('m32_5') }),
  m({ id: 'm16_4', round: 'r16', order: 4, kickoff: '2026-07-06T02:00:00+02:00', venue: 'Estadio Azteca · Ciudad de México', home: W('m32_7'), away: W('m32_8') }),
  m({ id: 'm16_5', round: 'r16', order: 5, kickoff: '2026-07-06T21:00:00+02:00', venue: 'AT&T Stadium · Dallas', home: W('m32_12'), away: W('m32_11') }),
  m({ id: 'm16_6', round: 'r16', order: 6, kickoff: '2026-07-07T02:00:00+02:00', venue: 'Lumen Field · Seattle', home: W('m32_10'), away: W('m32_9') }),
  m({ id: 'm16_7', round: 'r16', order: 7, kickoff: '2026-07-07T18:00:00+02:00', venue: 'Mercedes-Benz Stadium · Atlanta', home: W('m32_15'), away: W('m32_14') }),
  m({ id: 'm16_8', round: 'r16', order: 8, kickoff: '2026-07-07T22:00:00+02:00', venue: 'BC Place · Vancouver', home: W('m32_13'), away: W('m32_16') }),
]

// ————— Cuartos —————
const qf: Match[] = [
  m({ id: 'qf_1', round: 'qf', order: 1, kickoff: '2026-07-09T22:00:00+02:00', venue: 'Gillette Stadium · Boston', home: W('m16_1'), away: W('m16_2') }),
  m({ id: 'qf_2', round: 'qf', order: 2, kickoff: '2026-07-11T23:00:00+02:00', venue: 'Hard Rock Stadium · Miami', home: W('m16_3'), away: W('m16_4') }),
  m({ id: 'qf_3', round: 'qf', order: 3, kickoff: '2026-07-10T21:00:00+02:00', venue: 'SoFi Stadium · Los Ángeles', home: W('m16_5'), away: W('m16_6') }),
  m({ id: 'qf_4', round: 'qf', order: 4, kickoff: '2026-07-12T03:00:00+02:00', venue: 'Arrowhead Stadium · Kansas City', home: W('m16_7'), away: W('m16_8') }),
]

// ————— Semifinales —————
const sf: Match[] = [
  m({ id: 'sf_1', round: 'sf', order: 1, kickoff: '2026-07-14T21:00:00+02:00', venue: 'AT&T Stadium · Dallas', home: W('qf_1'), away: W('qf_2') }),
  m({ id: 'sf_2', round: 'sf', order: 2, kickoff: '2026-07-15T21:00:00+02:00', venue: 'Mercedes-Benz Stadium · Atlanta', home: W('qf_3'), away: W('qf_4') }),
]

// ————— Final —————
const final: Match[] = [
  m({ id: 'final_1', round: 'final', order: 1, kickoff: '2026-07-19T21:00:00+02:00', venue: 'MetLife Stadium · Nueva York/N.J.', home: W('sf_1'), away: W('sf_2') }),
]
